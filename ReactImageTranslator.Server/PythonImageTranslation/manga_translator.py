...
#for single image
#image_filepath = 'test/frieren2.png'

#for multiple images
base_folder = sys.argv[1] #'folderToTranslate'
...
translator = th.Translator(th.TranslatorService.GOOGLE, th.Language.JAPANESE, th.Language.ENGLISH)
